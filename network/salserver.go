...
func NewSalServer(rc, sd chan *proto.SalPack) *SalServer {
    ...
    return &SalServer{sal: sal, recvChan: rc, sendChan: sd}
}
...
func (this *SalServer) subscribe() {
    C.openyy_SAL_SubscribeHashChRange(this.sal, 0, 0, 43670710);
}

func (this *SalServer) parseAndSendMsgToSal() {
